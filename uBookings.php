...
if(isset($_POST['insert']))
{
     ...
     if(mysql_query($sql,$conn))
    {
        ...
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uBookingsView.php';</script>");
    }
    else
    {
        echo "<script>alert('Something is wrong please book again');</script>";
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uBookings.html';</script>");
    }
}
mysql_close($conn);
