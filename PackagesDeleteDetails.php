...
<head>
  ...
  <title>MedTour-Package Delete Details</title>
...
<h1 class="impact" style="color:black;"><b>Show Data</b></h1> -->
    ...
    <form name="packages" method="Post" action="PackagesDeleteSave.php" onsubmit="return validate();">
      ...
      <table align="center" cellpadding="10" bgcolor="white" style="border:1px solid black" bordercolor="#D7DF01">
        ...
        <tr>
          <td>Package Days :</td>
          <td><input type="number" name="D5" value="<?php echo $D5; ?>" readonly /></td>
        </tr>


        <tr>
          <td>Charges :</td>
          <td><input type="number" name="D6" value="<?php echo $D6; ?>" readonly /></td>
        </tr>
        ...
        <tr>
          <td>
            <a href="PackagesDelete.php" class="back">Back</a>
          </td>
          <td>
