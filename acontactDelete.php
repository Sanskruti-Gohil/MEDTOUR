...
while($row=mysql_fetch_array($result))
{
    $DB_Cname=$row['nm'];
    $DB_Cemail=$row['email'];
    $DB_Csubject=$row['subject'];
    $DB_Cmsg=$row['msg'];
?>

<tr>

<td><?php echo $DB_Cname;?></td>
<td><?php echo $DB_Cemail;?></td>
<td><?php echo $DB_Csubject;?></td>
<td><?php echo $DB_Cmsg;?></td>
<td><a class="button" href="acontactDeleteDetails.php?email=<?php echo $DB_Cemail;?>">Delete</a></td>
</tr>
