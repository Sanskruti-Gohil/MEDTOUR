...
<head>
    ...
    <title>MedTour-Appointment</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <!-- <a href="Appointments.html" class="nav-item nav-link">Appointment</a> -->
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Appointment</a>
                    <div class="dropdown-menu m-0">
                        <a href="Appointments.html" class="dropdown-item">Make Appointment</a>
                        <a href="hAppointmentsView.php" class="dropdown-item">View Appointment</a>
                    </div>
                </div>
                <a href="about.html" class="nav-item nav-link">About us</a>
                <a href="contact.html" class="nav-item nav-link">Contact us</a>
                <!-- <a href="DoctorsView.php" class="nav-item nav-link">Doctors</a>                
                <a href="PackagesView.php" class="nav-item nav-link">Packages</a> -->
                <!-- <a href="#" class="nav-item nav-link">Reviews</a> -->
                
                <!-- <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Packages</a>
                    <div class="dropdown-menu m-0">
                        <a href="price.html" class="dropdown-item">Packages Details</a>
                        <a href="team.html" class="dropdown-item">Doctors Details</a>
                        <a href="testimonial.html" class="dropdown-item">Reviews</a>
                        <a href="appointment.html" class="dropdown-item">Specialities</a>
                    </div>
                </div> -->
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Login</a>
                    <div class="dropdown-menu m-0">
                        <a href="Userlogin.html" class="dropdown-item">Staff</a>
                        <a href="Adminlogin.html" class="dropdown-item">Admin</a>
                    </div>
                </div>
                <a href="Registration.html" class="nav-item nav-link">Signup</a>
            </div>
...
$sql="select * from `appointments` ORDER BY `appdt` DESC";
...
<tr>
<td align="center"><?php echo $DB_PatientId;?></td>
            ...
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="Appointments.html"><i class="bi bi-arrow-right text-primary me-2"></i>Appointment</a>
                        <a class="text-light mb-2" href="hAppointmentsView.php"><i class="bi bi-arrow-right text-primary me-2"></i>View Appointment</a>
                        <a class="text-light mb-2" href="contact.html"><i class="bi bi-arrow-right text-primary me-2"></i>Contact Us</a>
                        <a class="text-light" href="Registration.html"><i class="bi bi-arrow-right text-primary me-2"></i>Signup</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-9 text-center text-md-start">
                    <p class="mb-md-0"><a class="text-white border-bottom" href="#">MedTour </a>&copy; <a class="text-white border-bottom" href="#">Jhil Patel, Sankruti Gohil, Nandlal Patil, Sahil Solanki</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
