...
if(isset($_POST['insert']))
{
    ...
    if(mysql_query($sql,$conn))
    {
        ...
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uHotelbookingsView.php';</script>");
    }
    else
    {
        echo "<script>alert('Something is wrong please try booking again');</script>";
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uHotelbookings.html';</script>");
    }
}
mysql_close($conn);
?>