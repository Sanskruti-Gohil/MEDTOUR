...
if(isset($_POST['insert']))
{
    ...
    {
        echo "<script>alert('Appointment Taken');</script>";
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uAppointmentsView.php';</script>");
    }
    else
    {
        echo "<script>alert('Something is wrong please book the appointment again');</script>";
        echo ("<script LANGUAGE='JavaScript'>window. location. href='uAppointments.html';</script>");
    }
}
mysql_close($conn);
