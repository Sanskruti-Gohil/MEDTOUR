            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="aAppointments.html" class="dropdown-item">Insert</a>
                            <a href="AppointmentsEdit.php" class="dropdown-item">Update</a>
                            <a href="AppointmentsDelete.php" class="dropdown-item">Delete</a>
                            <a href="AppointmentsView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="aRegistration.html" class="dropdown-item">Insert</a>
...
<td><a class="button" href="BookingsDeleteDetails.php?bcode=<?php echo $DB_Bookingcode;?>">Delete</a></td>
</tr>
