...
<head>
  ...
  <title>MedTour-Registration Delete Details</title>
...
<h1 class="impact" style="color:black;"><b>Show Data</b></h1> -->
    <h1 class="impact" style="color: black; text-align: center; margin: 10px">
      <b>Registration Delete Information</b>
    </h1>

    <form name="registration" method="Post" action="RegistrationDeleteSave.php" onsubmit="return validate();">
...
<tr>
<td>
                <a href="RegistrationDelete.php" class="back">Back</a>
              </td>
<td>
