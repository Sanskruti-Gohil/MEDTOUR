...
<head>
	...
	<title>MedTour-Hotel Booking Delete Details</title>
...
<h1 class="impact" style="color: black; text-align: center; margin: 10px">
        <b>Hotel Booking Informations</b>
      </h1>

      <form method="Post" action="HotelbookingsDeleteSave.php" name="hotelbookings" onsubmit="return validate();">
...
<tr>
<td>
                    <a href="HotelBookingsDelete.php" class="back">Back</a>
                </td>
<td>
