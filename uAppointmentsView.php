                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#"> Package Booking   &raquo </a>
                                    ...
                                    <ul class="submenu dropdown-menu">
                                        <li><a class="dropdown-item" href="uBookings.html"> Insert</a></li>
                                        <!-- <li><a class="dropdown-item" href="uBookingsEdit.php"> Update</a></li> -->
                                        <!-- <li><a class="dropdown-item" href="uBookingsDelete.php"> Delete</a></li> -->
                                        <li><a class="dropdown-item" href="uBookingsView.php"> View</a></li>
                                    </ul>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#"> Appointment   &raquo </a>
                                    ...
                                    <ul class="submenu dropdown-menu">
                                        <li><a class="dropdown-item" href="uAppointments.html"> Insert</a></li>
                                        <!-- <li><a class="dropdown-item" href="uAppointmentsEdit.php"> Update</a></li> -->
                                        <!-- <li><a class="dropdown-item" href="uAppointmentsDelete.php"> Delete</a></li> -->
                                        <li><a class="dropdown-item" href="uAppointmentsView.php"> View</a></li>
                                    </ul>
