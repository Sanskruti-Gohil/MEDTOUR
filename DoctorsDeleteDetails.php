...
<head>
  ...
  <title>MedTour-Doctor Delete Details</title>
...
<h1 class="impact" style="color:black;"><b>Show Data</b></h1> -->
    <h1 class="impact" style="color: black; text-align: center; margin: 10px">
      <b>Doctor Delete Information</b>
    </h1>

    <form method="Post" action="DoctorsDeleteSave.php" onsubmit="return validate();">
      ...
      <table align="center" cellpadding="10" bgcolor="white" style="border:1px solid black" bordercolor="#D7DF01">
        ...
        ?>
            ...
            <tr>
              <td>Phone No :</td>
              <td><input type="number" name="D8" value="<?php echo $D8; ?>" readonly /></td>
            </tr>

            <tr>
              <td>Email Id :</td>
              <td><input type="email" name="D9" value="<?php echo $D9; ?>" readonly /></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="text" name="D11" value="<?php echo $D11; ?>" readonly /></td>
            </tr>

            <tr>
              <td>About Doctors :</td>
              <td><input type="text" name="D12" value="<?php echo $D12; ?>" readonly /></td>
            </tr>

            <tr>
              <td>Consultation Time :</td>
              <td><input type="time" name="D13" value="<?php echo $D13; ?>" readonly /></td>
            </tr>


            <tr>
              <td>
                <a href="DoctorsDelete.php" class="back">Back</a>
              </td>
              <td>
