...
$con=mysqli_connect('localhost','root','','medtour');
    ...
    if(mysqli_query($con,$sql))
    {
        ...
        echo ("<script LANGUAGE='JavaScript'>window.location.href='HospitalsView.php';</script>");  
    }
    else
    {
        echo "<script>alert('Hospital Not Inserted Successfully');</script>";
        echo ("<script LANGUAGE='JavaScript'>window.location.href='Hospitals.html';</script>");
    }
